...
const RateProduct = (props) => {
    ...
    const _handleStarSelection = (fiveStar, fourStar, threeStar, twoStar, oneStar) => {
        setValue({
            ...value,
            fiveStar: fiveStar,
            fourStar: fourStar,
            ...
            <MowContainer
                ...
                <KeyboardAwareScrollView
                    ...
                    <View
                        ...
                        {/* star view container */}
                        <TouchableOpacity
                            onPress={() => _handleStarSelection(true, false, false, false, false)}
                        ...
                        {/* star view container */}
                        <TouchableOpacity
                            onPress={() => _handleStarSelection(false, true, false, false, false)}
                            style={starStyle.container}>
                        ...
                        {/* star view container */}
                        <TouchableOpacity
                            onPress={() => _handleStarSelection(false, false, true, false, false)}
                            style={starStyle.container}>
                        ...
                        {/* star view container */}
                        <TouchableOpacity
                            onPress={() => _handleStarSelection(false, false, false, true, false)}
                            style={starStyle.container}>
                        ...
                        {/* star view container */}
                        <TouchableOpacity
                            onPress={() => _handleStarSelection(false, false, false, false, true)}
                            style={starStyle.container}>
                    ...
                    <View
                        ...
                        <MowInput
                            ...
                            onChangeText={value => onChangeText('reviewText', value)} />
