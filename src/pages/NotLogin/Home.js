        ...
        <MyContainer
            ...
            <View
                ...
                <View
                    ...
                    <MowButtonBasic
                        onPress={() => {
                            props.navigation.navigate("NormalLogin",{product:props.route.params?.product})
                        }}
                        size={"big"}
                ...
                <MowButtonBasic
                    onPress={() => { props.navigation.navigate("NormalRegister",{product:props.route.params?.product}) }}
                    type={"success"}>
