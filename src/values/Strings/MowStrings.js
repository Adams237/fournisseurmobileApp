...
export const mowStrings = new LocalizedString({
    ...
    en: {
        ...
        loginHome: {
            withEmail: "Se connecter avec son email",
            withFacebook: "Sign in with Facebook",
            withGoogle: "Sign in with Google",
            newHere: "N'avez-vous pas de compte?",
        ...
        signUpPage: {
            ...
            securityCodeMessage: "Pour utiliser leratelApp,\nnous avons envoyer un mail de vérification à\n",
            verificationCodeMessage: "Verifiez votre boite mail et cliquez sur le lien que vous avez reçu\nEnsuite revenez vous connecter via la page de connexion. Si vous ne trouvez pas de messages dans votre boite de reception, vérifier dans les SPAM",
            codeError: "N'avez-vous pas reçu de mail?",
        ...
        loginPage: {
            ...
            cantAccessAccount: "Vous n'arrivez pas à accéder à votre compte?"
        },
        passwordPage: {
            title: "Password",
        },
        ...
        extraSecurity: {
            ...
            infoMessage: "Veillez vérifier votre boite mail, un mail de reinitialisation vous a été envoyé à l'adress  ",
            timeRemaining: "Vous pourrez demander un autre mail dans ",
            noVerificationCode: "Aucun email reçu?"
        },
    ...
    de: {
        ...
        homeScreen: {
            ...
            bestDiscounts: "Prouits Recherchés",
            bestSeller: "Bestseller",
            outOfStock: "Rupture de stoc",
